...
(function (h) {
    ...
    function Kb(a) {
        for (var b, c, d = a.aoColumns, e = Y(a), a = a.oLanguage.oAria, f = 0, g = d.length; f < g; f++) {
            ...
            c.bSortable &&
             ...
             (0 < e.length && e[0].col == f ? (i.setAttribute("aria-sort", "asc" == e[0].dir ? "descending" : "ascending"), (c = j[e[0].index + 1] || j[0])) : (c = j[0]), (b += "asc" === c ? a.sSortDescending : a.sSortAscending));
    ...
    l.defaults = {
        ...
        oLanguage: {
            ...
            oAria: { sSortDescending: ": activate to sort column ascending", sSortAscending: ": activate to sort column descending" },
