...
(function (h) {
        ...
        if (-1 !== h.inArray(!1, c)) D(a, !1);
            ...
            if (0 !== n.length) {
                ...
                (d = g.sZeroRecords),
                    ...
                    (c[0] = h("<tr/>", { class: f ? e[0] : "" }).append(h("<td />", { valign: "top", colSpan: W(a), class: a.oClasses.sRowEmpty }).html(d))[0]);
    ...
    function ma(a) {
        ...
        if (a.scrollBarVis !== M && a.scrollBarVis !== k) (a.scrollBarVis = M), aa(a);
        else {
            a.scrollBarVis = M;
        ...
        if (d || (!r && !f && !e && j == W(a) && j == n.length)) for (l = 0; l < j; l++) (i = ba(a, l)), null !== i && (c[i].sWidth = w(n.eq(l).width()));
            ...
            for (l = 0; l < i.length; l++)
                (o = c[i[l]]),
                    ...
                    o.sWidthOrig && f && h(n[l]).append(h("<div/>").css({ width: o.sWidthOrig, margin: 0, padding: 0, border: 0, height: 1 }));
    ...
    l.defaults = {
        ...
        oLanguage: {
            ...
            sDecimal: "",
            sThousands: ",",
            sLengthMenu: "Show _MENU_ Supplier Per List",
            sLoadingRecords: "Loading...",
            sProcessing: "Processing...",
            sSearch: `<button class="add-supplier-btn" data-bs-toggle="modal" data-bs-target="#addSupplier" > Add New Supplier <i class="fas fa-user-plus"></i> </button>`,
            sSearchPlaceholder: "",
            sUrl: "",
